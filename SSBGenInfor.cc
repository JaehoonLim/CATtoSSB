...
SSBGenInfor::ReturnChannel(const edm::Event& iEvent) {
    ...
    if(isSignal){
        if(ChannelIndex == -30) ChannelName = "TauTau";
        ...
        else if(ChannelIndex ==   0) ChannelName = "Hadronic";
        else if(ChannelIndex ==  11) ChannelName = "Electron+Jets";
        else if(ChannelIndex ==  13) ChannelName = "Muon+Jets";
        else if(ChannelIndex ==  22) ChannelName = "Electron_Dilepton";
        else if(ChannelIndex ==  24) ChannelName = "ElectronMuon_Dilepton";
        else if(ChannelIndex ==  26) ChannelName = "Muon_Dilepton";
        else {
