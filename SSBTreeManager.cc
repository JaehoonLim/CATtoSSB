...
void SSBTreeManager::Book(TTree* tree){
    ...
    ssbtree->Branch("DiLepton_InvMass1", &VariableBox_Double["DiLepton_InvMass1"], "DiLepton_InvMass1/D");
    ssbtree->Branch("DiLepton_InvMass2", &VariableBox_Double["DiLepton_InvMass2"], "DiLepton_InvMass2/D");
    ssbtree->Branch("DiLepton_InvMass3", &VariableBox_Double["DiLepton_InvMass3"], "DiLepton_InvMass3/D");
...
void SSBTreeManager::InitializeVariables(){
    ...
    VariableBox_Double["DiLepton_InvMass1"] = 0;
    VariableBox_Double["DiLepton_InvMass2"] = 0;
    VariableBox_Double["DiLepton_InvMass3"] = 0;
